...
#define DNA_UNI_IDENTITY_BLOCKS		22
...
#define	DNA_EYESWITCH_BLOCK			7
#define DNA_GENDER_BLOCK			8
#define DNA_FACIAL_HAIR_STYLE_BLOCK	9
#define DNA_HAIR_STYLE_BLOCK		10
#define DNA_COLOR_ONE_BLOCK		13
#define DNA_COLOR_TWO_BLOCK		14
#define DNA_COLOR_THR_BLOCK		15
#define DNA_COLOR_SWITCH_BLOCK		16
#define DNA_COLOR_SWITCH_MAX			7 //must be (2^(n+1))-1
#define DNA_COCK_BLOCK				17
#define DNA_MUTANTRACE_BLOCK		18
#define DNA_MUTANTTAIL_BLOCK		19
#define DNA_MUTANTWING_BLOCK		20
#define DNA_WINGCOLOR_BLOCK			21
#define DNA_TAUR_BLOCK				22
